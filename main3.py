...
tt = '../' + 'traindata_'+args.dataset+'_niid3.pkl'
with open(tt, 'rb') as f:
    net_dataidx_map = pickle.load(f)
    
tt = '../' + 'testdata_'+args.dataset+'_niid3.pkl'
with open(tt, 'rb') as f:
    net_dataidx_map_test = pickle.load(f)
    
tt = '../' + 'traindata_cls_counts_'+args.dataset+'_niid3.pkl'
with open(tt, 'rb') as f:
    traindata_cls_counts = pickle.load(f)
    
tt = '../' + 'testdata_cls_counts_'+args.dataset+'_niid3.pkl'
with open(tt, 'rb') as f:
    testdata_cls_counts = pickle.load(f)

tt = '../' + 'init_simple_cnn_'+args.dataset+'.pth'
initial_state_dict = torch.load(tt)
